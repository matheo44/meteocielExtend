...
const settings = [
  ...
  { key: "isobares", value: "Isobares", lien:"https://www.meteociel.fr/cartes_obs/pression.png" },
  ...
  { key: "satellite", value: "Satellite", lien:"https://neige.meteociel.fr/satellite/anim_ir.gif" },
...
settings.forEach(setting => {
  ...
  input.addEventListener("change", () => {
    ...
    if(input.checked)
    {
      document.getElementById(setting.key)
      document.getElementById(setting.lien)
     /*<div id=settings.key>
       document.getElementById(setting.lien)
       <img src="settings.lien" />
     </div>
  
      //document.getElementById("fenetre2");.setAttribute("src",setting.lien);
    }
  });
  document.createTextNode(setting.value);
});*/
const settingsDiv = document.querySelector(".settings");
const toggleSettings = document.querySelector("#toggleSettings");
